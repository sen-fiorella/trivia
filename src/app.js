...
if (valorCine1==="1" && checkCine1===true){
    ...
    cine2.classList.remove("hide");
    cine1.classList.add("hide");
...
next2.addEventListener("click",() =>{
   ...
   if (valorCine2==="1" && checkCine2===true){
       ...
       cine3.classList.remove("hide");
       cine2.classList.add("hide");
